...
namespace Clase_Mascotas{
    ...
    public class Ave : Mascotas{
        ...
        public Ave (string nombre, double peso, char sexo, int edad, string propietario, bool estado, int envergadura, bool volar): base (nombre, peso, sexo, edad, propietario, estado)
        ...
        public override CalcularDosis(double dosis){
